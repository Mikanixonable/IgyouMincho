#pngからot-svgカラーフォントとcolr/cpalカラーフォントを自動生成するプログラム
"""
依存：
cmdにパスを通すもの: magick, potrace, fontforge, nanoemoji
python環境にインストールするもの: cv2,fonttools
...
def main():
    ...
    #####################実行########################
    #ot-svgからフォント用のフォールバック白黒フォントの作成
